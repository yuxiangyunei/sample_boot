...
void msgPackDelayReq(const PtpClock *ptpClock, Octet *buf, const Timestamp *originTimestamp)
{
    ...
    *(UInteger32 *)(buf + 36) = flip32(originTimestamp->secondsField.lsb);
    *(UInteger32 *)(buf + 40) = flip32(originTimestamp->nanosecondsField);
    *(UInteger16 *)(buf + 34) = flip16(0);
    *(UInteger32 *)(buf + 36) = flip32(0);
    *(UInteger32 *)(buf + 40) = flip32(0);
}
...
void msgPackDelayResp(	const PtpClock *ptpClock,
                        Octet *buf,
...
void msgPackPDelayResp(	Octet *buf,
                        const MsgHeader *header,
...
void msgPackPDelayRespFollowUp(	Octet *buf,
                                const MsgHeader *header,
