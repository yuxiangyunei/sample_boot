...
#else
#define DEFAULT_DOMAIN_NUMBER 8
#endif
#define DEFAULT_DELAY_MECHANISM E2E //P2P
#define DEFAULT_AP 2u
#define DEFAULT_AI 16u
...
#define DEFAULT_SYNC_INTERVAL 0 /* -7 in 802.1AS */ //决定发送SYNC的频率
...
#define DEFAULT_CLOCK_CLASS 255
